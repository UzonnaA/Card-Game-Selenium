...
async function runTest1() {
    ...
    try {
        ...
        await driver.wait(until.elementTextContains(driver.findElement(By.id('game-message')), "Press Enter to continue."), 10000);
        console.log("Game started successfully.");

        let enterButton = await driver.findElement(By.xpath("//button[contains(text(), 'Enter')]"));
        for (let i = 0; i < 3; i++) {
